...
public class TFIDF {
    ...
    public static void main(String[] args) throws IOException
    {
...

        {
            ...
            HashMap<String, Float> TFIDMap = new HashMap<>();
            ...
            for(String term: cleanQueryWords) {
                ...
                for(int key : TFmap.keySet()) {
                    ...
                    Float TF_IDFWD = (float) (okapiTFScore * (Math.log(docIdMap.size() / TFmap.size())));

                    TFIDMap.put(docNo, TFIDMap.get(docNo) == null ? TF_IDFWD : TFIDMap.get(docNo) + TF_IDFWD);
                }
            }

            sortedMap = sortScoreMap(TFIDMap);
            ...
            for (String docNo : qrelDocs) {
                ...
                if(sortedMap.get(String.valueOf(d)) != null) {
                    writer.println(queryNo + " Q0 " + docNo + " " + rank + " " + sortedMap.get(String.valueOf(d)) + " TFIDF");
                    sortedMap.remove(String.valueOf(d));
                } else {
                    writer.println(queryNo + " Q0 " + docNo + " " + rank + " " + nthValue + " TFIDF");
                }
            }
...
//                if(rank < 1000) {
//                    rank = rank + 1;
//                    writer.println(queryNo + " Q0 " + keys.get(i) + " " + rank + " " + top1000.get(keys.get(i)) + " TFIDF");
//                } else
//                    break;
//            }
            ...
            for(String doc: nonRelDocsForQuery) {
                ...
                writer.println(queryNo + " Q0 " + doc + " " + rank + " " + sortedMap.get(String.valueOf(d)) + " TFIDF");
            }
