...
public class OutputAccuracy {
    ...
    public static void main(String[] args) throws IOException {
        String expected = "/Users/paulomimahidharia/Desktop/IR/CustomIndexer/expected.txt";
        String actual = "/Users/paulomimahidharia/Desktop/IR/CustomIndexer/Output.stopped.stemmed.txt";
    ...
    * 2. file path of actual output (student's version)
    ...
    public static void compareFiles(String expected, String actual) throws IOException {
        ...
        System.out.println(expected_map.size());
        System.out.println(actual_map.size());

        int errors =
            expected_map
                    .entrySet()
                    .stream()
                    .map(entrySet -> compare(entrySet.getKey(), entrySet.getValue(), actual_map.get(getStem(entrySet.getKey()))))
                    .filter(bool -> bool)
